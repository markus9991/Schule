 ...
 * werden soll. Da leJOS NXJ zum gegenwärtigen Zeitpunkt (0.4 Beta) noch keine
 * GarbageCollection unterstützt und um das Datenvolumen möglichst gering zu
 * halten, sind alle Variablen, die für den Betrieb unerlässlich sind, global
 * definiert.
 * 
 * @author Christian
 */
public class LegoHamster {
	...
	/*
	 * Wert für den Mittelpunkt
	 */
	final int BLACK = 39;

	/*
	 * Wert für die Hintergrundsfläche
	 */
	final int WHITE = 52;
	...
	public void _intern_lay_down_002() {
		...
		pilot.stop();
		pilot.travel(-70);
		Motor.C.rotate(70); // Greifer öffnen
		pilot.travel(-80);
		// Greifer schliessen
