...
public class CompilerTools implements Observer {
	...
	/**
	 * Löst das Formatieren aus.
	 */
	public class FormatAction extends ForwardAction {
		public FormatAction() {
			super("compiler.format", CompilerController.ACTION_FORMAT);
		}
	}
	...
	public CompilerTools(CompilerModel model, CompilerController controller) {
		...
		compileMenu.add(new JMenuItem(formatAction));
